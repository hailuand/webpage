  ...
  return (
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6">
        ...
        <Section>
          <h2 className="text-xl font-bold">Programming Languages ⌨️</h2>
            ...
            {RESUME_DATA.talks.map((talk) => {
              return (
                <TalkCard
                  ...
                  topics={talk.topics}
                  link={"link" in talk ? talk.link.href : undefined}
                />
              );
            })}
          </div>
        ...
        <Section className="print-force-new-page scroll-mb-16">
          <h2 className="text-xl font-bold">Projects & Contributions 🚀</h2>
          <div className="mt-2">
            <img src="https://ghchart.rshah.org/hailuand" alt="hailuand's Github chart" />
          </div>
          <div className="-mx-3 grid grid-cols-1 gap-3 print:grid-cols-3 print:gap-2 md:grid-cols-2 lg:grid-cols-3">
