...
export const RESUME_DATA = {
  ...
  location: "San Diego",
  initials: "AH",
  locationLink: "https://maps.app.goo.gl/7izt2aWzpQfBmuN39",
  ...
  avatarUrl:
    "https://raw.githubusercontent.com/hailuand/webpage/master/src/app/profile.jpg",
  contact: {
  ...
  work: [
    {
      company: "Microsoft",
      link: "https://azure.microsoft.com/en-us/products/ai-services/ai-search",
      badges: [],
  ...
  projects: [
    {
      title: "CorgiMQ",
      techStack: ["Open Source", "Java", "JDBC", "RDBMS"],
      description:
    ...
    {
      title: "Apache Avro",
      techStack: ["Open Source", "Data Format", "Serialization"],
    ...
    {
      title: "Webpage",
      techStack: ["Personal", "Next.js", "React"],
      description:
